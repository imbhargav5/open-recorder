...
export function ShortcutsConfigDialog() {
	...
	const [draft, setDraft] = useAtom(shortcutsDraftAtom);
	const [captureFor, setCaptureFor] = useAtom(shortcutCaptureForAtom);
	const [conflict, setConflict] = useAtom(shortcutConflictAtom);
	const resetDraft = useSetAtom(resetShortcutsConfigDraftAtom);
	...
	useEffect(() => {
		if (isConfigOpen) {
			resetDraft(shortcuts);
		}
	}, [isConfigOpen, resetDraft, shortcuts]);
	...
	}, [setCaptureFor, setConflict, setDraft]);
	...
	const handleClose = useCallback(() => {
		...
		setConflict(null);
		closeConfig();
	}, [closeConfig, setCaptureFor, setConflict]);
