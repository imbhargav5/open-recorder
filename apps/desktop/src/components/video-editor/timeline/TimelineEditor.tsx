...
function PlaybackCursor({
	...
	const [isDragging, setIsDragging] = useAtom(timelinePlaybackCursorDraggingAtom);
...
function TimelineEditorInner({
	...
	}, [aspectRatio, setCustomAspectHeight, setCustomAspectWidth]);
	...
	}, [currentTimeMs, totalMs, keyframes, setKeyframes]);
