...
type BuiltInWallpaperSource = Omit<BuiltInWallpaper, "thumbnailPublicPath">;

const BUILT_IN_WALLPAPER_SOURCES: BuiltInWallpaperSource[] = [
	{
		id: "wallpaper-1",
		label: "Wallpaper 1",
...
export const BUILT_IN_WALLPAPERS: BuiltInWallpaper[] = BUILT_IN_WALLPAPER_SOURCES.map(
	(wallpaper) => ({
		...wallpaper,
		thumbnailPublicPath: wallpaper.publicPath.replace("/wallpapers/", "/wallpapers/thumbs/"),
	}),
);
