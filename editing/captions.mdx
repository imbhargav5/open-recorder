...
description: "Set up the on-device speech model and a local Ollama text model, generate captions, edit text and timing, restyle the track, and include on export."
---
